...
describe('Cart', () => {
  ...
  describe('getTotal()', () => {
    it('should return 0 when getTotla() is executed in a newly created instance', () => {
  ...
  describe('checkout()', () => {
    ...
    it('shoul reset the cart when checkout() is called', () => {
      cart.add({
        product: product2,
        quantity: 5,
      });
  ...
  describe('special conditions', () => {
    ...
    it('should NOT apply percentage discount quantity is bellow or equal minumum', () => {
      const condition = {
        percentage: 30,
        minimum: 2,
      };
